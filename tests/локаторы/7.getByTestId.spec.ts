...
test.describe('Тесты для формы и продуктов', () => {
  ...
  test('Заполнить форму заказа', async ({ page }) => {
    const form = page.getByTestId('order-form'); // TODO(student): замените на корректный локатор
...
test.describe('Специальные случаи для getByTestId()', () => {
  ...
  test('Проверить скрытый элемент', async ({ page }) => {
    const hiddenElement = page.getByTestId('hidden-element'); // TODO(student): замените на корректный локатор
  ...
  test('Проверить футер страницы', async ({ page }) => {
    // const footer = page.getByTestId('copyright-text'); // TODO(student): замените на корректный локатор
    const copyright = page.getByTestId('copyright-text');
